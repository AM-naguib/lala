...
- Design Batch 11.2 is delivered for review: Essential, Editorial, and Bold now use materially different Header, Hero, product, collection, promotion, story, benefits, and Footer compositions while sharing one section document. Content, order, visibility, RTL behavior, and prices remain unchanged. The static suite passes 19/19.
